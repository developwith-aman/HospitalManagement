...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public DepartmentDTO addNewDepartment(AddNewDeptDTO addNewDeptDTO) {
        ...
        if (departmentRepository.existsByDepartmentName(addNewDeptDTO.getDepartmentName()) &&
                departmentRepository.existsById((long) addNewDeptDTO.getDepartmentHeadId())) {
            throw new IllegalArgumentException("Head Doctor already assigned OR Department already present, can't perform this action...");
        } else {
        ...
        public ApiResponse addDoctorsToDept (Doctor_DepartmentDTO doctorDepartmentDTO){
            ...
            if (!department.getDoctors().contains(doctor)) {
                ...
                throw new IllegalArgumentException("Doctor already present in this department, no need to add again...");
